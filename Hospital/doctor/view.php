            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $query = "SELECT p.*, a.symptoms, a.status
                        FROM patient p 
                        JOIN appointment a join income i ON p.id = a.patient_id 
                        WHERE p.id = '$id' LIMIT 1"; // Assuming one active appointment per patient

                        $res = mysqli_query($connect, $query);
                        $patient = mysqli_fetch_array($res);
                        $doctorId = $_SESSION['doctor_id'];
                        // Fetch all appointments for this patient
                        $appointment_query = "SELECT * FROM appointment WHERE patient_id = '$id'and doctor_id ='$doctorId'" ;
