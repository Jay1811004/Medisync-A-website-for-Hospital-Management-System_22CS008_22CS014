...
if(!$res) {
    ...
    mysqli_query($connect, "UPDATE appointment SET status='Discharge', description='$des', amount_paid='$fee' WHERE id='$id'");
}
                                        }
                                    }
                                ...
                                <form method="post">
                                    <label>Fee</label>
                                    <input type="number" name="fee" class="form-control" autocomplete="off" palceholder="Enter patient Fee">
                                    <br>
                                    <label>Description</label>
                                    <input type="text" name="des" class="form-control" autocomplete="off" palceholder="Enter description">
                                    <br>
