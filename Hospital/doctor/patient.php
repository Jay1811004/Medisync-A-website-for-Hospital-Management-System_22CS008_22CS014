            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <?php
                        ...
                        // $query = "SELECT p.*, a.status FROM patient p 
                        //           JOIN appointment a ON p.id = a.patient_id 
                        //           WHERE a.doctor_id = '$doctorId'";

                        // $query = "select p.*, a.status, a.description,a.amount_paid from patient p
                        // join appointment a on p.id = a.patient_id where a.doctor_id = '$doctorId'";

                        $query = "SELECT DISTINCT firstname,patient_id
