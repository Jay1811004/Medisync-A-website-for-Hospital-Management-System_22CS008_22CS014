...
if (isset($_POST['upload'])) {
    ...
    if (empty($img)) {
        ...
        $query = "UPDATE patient SET profile='$img' WHERE username='{$_SESSION['patient']}'";
...
if (isset($_POST['change_uname'])) {
    ...
    if (empty($uname)) {
        ...
        $query = "UPDATE patient SET username='$uname' WHERE username='{$_SESSION['patient']}'";
        $res = mysqli_query($connect, $query);
        if ($res) {
...
if (isset($_POST['change_pass'])) {
    ...
    $ol = "SELECT password FROM patient WHERE username='{$_SESSION['patient']}'";
    ...
    if ($old != $row['password']) {
        ...
        $query = "UPDATE patient SET password='$new' WHERE username='{$_SESSION['patient']}'";
